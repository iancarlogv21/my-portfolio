...
export default function HeroAbout() {
  return (
    <section id="about" className="flex flex-col md:flex-row gap-8 items-start justify-between pb-12 border-b border-zinc-100 dark:border-zinc-900">
      ...
      {/* Larger Profile Image Frame with Hover Effect */}
      <div className="w-44 h-56 md:w-48 md:h-60 rounded-xl bg-zinc-100 dark:bg-zinc-900 overflow-hidden shadow-md shrink-0 border-2 border-zinc-300 dark:border-zinc-700 relative group">
        <img 
          src="/ian-photo.jpg" 
      ...
      <div className="flex-1 space-y-4">
        <div className="inline-flex items-center gap-2 px-2.5 py-1 rounded-full bg-zinc-100 dark:bg-zinc-900 text-xs font-mono text-zinc-600 dark:text-zinc-400">
          <span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse"></span>
          BSIT Student @ City College of San Fernando, Pampanga
        </div>
        ...
        <div className="flex flex-wrap items-center gap-4 text-xs font-mono text-zinc-500 pt-2">
          <a href="https://github.com/Iancarlogv21" target="_blank" className="flex items-center gap-1 hover:text-zinc-900 dark:hover:text-zinc-100 transition">
            <Code className="h-3.5 w-3.5" /> GitHub ↗
          </a>
          <a href="https://www.linkedin.com/in/ian-carlo-ventura-18b8a6296/" target="_blank" className="flex items-center gap-1 hover:text-zinc-900 dark:hover:text-zinc-100 transition">
            <Globe className="h-3.5 w-3.5" /> LinkedIn ↗
          </a>
          <a href="mailto:iancarlogventura@gmail.com" className="flex items-center gap-1 hover:text-zinc-900 dark:hover:text-zinc-100 transition">
