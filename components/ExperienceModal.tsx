...
export default function ExperienceModal({ isOpen, onClose }: ExperienceModalProps) {
  ...
  const timeline = [
    { year: "2026", title: "BS Information Technology — 4th Year", subtitle: "City College of San Fernando, Pampanga", desc: "Current academic standing focusing on full-stack web engineering, enterprise system architecture, and capstone leadership." },
    { year: "2026", title: "OJT / Internship & Industry Practice", subtitle: "FONZO Calibration and Car Services Co.", desc: "Developing automotive workshop intelligence systems, client scheduling tools, and production-ready workflow automation." },
    { year: "2025 — 2026", title: "Capstone Projects & Case Studies", subtitle: "FELMS & Full-Stack Systems", desc: "Engineered NoSQL MongoDB aggregation pipelines, digital library management portals, and comprehensive data analytics case studies." },
    { year: "2025", title: "Professional Certifications", subtitle: "Harvard CS50P, Google Analytics, Credly", desc: "Earned industry-recognized credentials in Python programming, data tracking, and cybersecurity fundamentals." },
    { year: "2024", title: "Design and UI Portals", subtitle: "Immersive Web Concepts", desc: "Designed high-end brand layouts and interactive user interfaces including esports portals, luxury hotel booking, and music stores." },
    { year: "2023", title: "Programming Foundations", subtitle: "Core Web Stack (PHP, MySQL, JavaScript)", desc: "Mastered relational database management, dynamic server-side scripting, and modern frontend styling with Tailwind CSS." },
    { year: "2022", title: "Tech Community & Collaborative Activities", subtitle: "Peer Programming & Academic Projects", desc: "Engaged in collaborative software development machine problems, shared repositories, and peer code reviews with classmates." },
    { year: "2019 — 2021", title: "Hello World!", subtitle: "ICT Strand / Junior High School", desc: "Wrote first lines of code, sparking a lifelong passion for software development and information technology." }
  ];
